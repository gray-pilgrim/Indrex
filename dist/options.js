...
const test = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", { className: "text-5xl text-green-500" }, "Help Page"),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Coming soon")));
